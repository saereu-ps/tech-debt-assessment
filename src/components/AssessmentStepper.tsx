...
const AssessmentStepper: React.FC<AssessmentStepperProps> = ({ onComplete }) => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center relative overflow-hidden bg-transparent">
      ...
      <div className="max-w-[1400px] w-full grid grid-cols-1 lg:grid-cols-[500px_1fr] gap-4 lg:gap-24 relative z-10 px-4 sm:px-8 py-6 md:py-12 items-center origin-center">
        
        {/* Left Column: Enlarged Sci-Fi Circular Stepper */}
        <div className="relative w-[500px] h-[500px] flex-shrink-0 mx-auto scale-[0.65] sm:scale-[0.8] md:scale-100 lg:scale-[0.85] xl:scale-[0.95] 2xl:scale-100 origin-center -my-24 sm:-my-12 md:my-0 lg:-my-8 xl:my-0">
